...
export default function AddCalendar({ isOpen, onClose, calendarTitle, handleSubmit, handleChange, onCancel }: addCalendarProps) {
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}>
            ...
            <form action="submit" onSubmit={handleSubmit}>
              <div className="mt-2">
                <input type="text" name="title" className="block w-full rounded-md border-0 py-1.5 text-gray-900 
                  ...
                  value={calendarTitle ?? ""} onChange={(e) => handleChange(e)} placeholder="Title" />
              </div>
